        ...
        {team.map((member, i) => {
          ...
          return (
            ...
            >
              ...
              {/* MP meter removed (upgrades/40-uses-based-move-data-model.md) --
                  no more aggregate resource to show; per-move uses render on
                  MoveButton instead (upgrades/43-uses-ui-and-server-validation.md). */}
            </button>
          );
        })}
      </div>
